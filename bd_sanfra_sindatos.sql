...
-- Volcando estructura para tabla se_sanfra.actasreincorporaciones
DROP TABLE IF EXISTS `actasreincorporaciones`;
...
-- Volcando estructura para tabla se_sanfra.analiticodatos
DROP TABLE IF EXISTS `analiticodatos`;
...
-- Volcando estructura para tabla se_sanfra.apf
...
-- Volcando estructura para tabla se_sanfra.aprendizajes
...
-- Volcando estructura para tabla se_sanfra.aspicursos_fps
DROP TABLE IF EXISTS `aspicursos_fps`;
...
-- Volcando estructura para tabla se_sanfra.aspiniveles
DROP TABLE IF EXISTS `aspiniveles`;
...
-- Volcando estructura para tabla se_sanfra.aspirantes_ento
DROP TABLE IF EXISTS `aspirantes_ento`;
...
-- Volcando estructura para tabla se_sanfra.aspirantes_entobackup
DROP TABLE IF EXISTS `aspirantes_entobackup`;
CREATE TABLE IF NOT EXISTS `aspirantes_entobackup` (
...
-- Volcando estructura para tabla se_sanfra.aspirantes_fps
DROP TABLE IF EXISTS `aspirantes_fps`;
...
-- Volcando estructura para tabla se_sanfra.ayuda
...
-- Volcando estructura para tabla se_sanfra.bancos
...
-- Volcando estructura para tabla se_sanfra.caja
...
-- Volcando estructura para tabla se_sanfra.calificaciones
...
) ENGINE=InnoDB AUTO_INCREMENT=116503 DEFAULT CHARSET=utf8;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.certalureg
DROP TABLE IF EXISTS `certalureg`;
...
-- Volcando estructura para tabla se_sanfra.certasistprof
DROP TABLE IF EXISTS `certasistprof`;
...
-- Volcando estructura para tabla se_sanfra.certestutram
DROP TABLE IF EXISTS `certestutram`;
...
-- Volcando estructura para tabla se_sanfra.certificacion
...
-- Volcando estructura para tabla se_sanfra.certificadojardin
DROP TABLE IF EXISTS `certificadojardin`;
...
-- Volcando estructura para tabla se_sanfra.certificadosextogrado
DROP TABLE IF EXISTS `certificadosextogrado`;
...
-- Volcando estructura para tabla se_sanfra.comprobanteafip
DROP TABLE IF EXISTS `comprobanteafip`;
...
-- Volcando estructura para tabla se_sanfra.comunicdocentes
DROP TABLE IF EXISTS `comunicdocentes`;
...
-- Volcando estructura para tabla se_sanfra.conceptos
...
-- Volcando estructura para tabla se_sanfra.condadeudada
DROP TABLE IF EXISTS `condadeudada`;
...
-- Volcando estructura para tabla se_sanfra.condaprobacion
DROP TABLE IF EXISTS `condaprobacion`;
...
-- Volcando estructura para tabla se_sanfra.condiciones
...
-- Volcando estructura para tabla se_sanfra.constdocu
DROP TABLE IF EXISTS `constdocu`;
...
-- Volcando estructura para tabla se_sanfra.contenidos
...
-- Volcando estructura para tabla se_sanfra.cubririnasdocentes
DROP TABLE IF EXISTS `cubririnasdocentes`;
...
-- Volcando estructura para tabla se_sanfra.cuotas
...
-- Volcando estructura para tabla se_sanfra.cuotasbecas
DROP TABLE IF EXISTS `cuotasbecas`;
...
-- Volcando estructura para tabla se_sanfra.cuotasgeneradas
DROP TABLE IF EXISTS `cuotasgeneradas`;
...
) ENGINE=InnoDB AUTO_INCREMENT=44189 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.cuotasimportes
DROP TABLE IF EXISTS `cuotasimportes`;
...
) ENGINE=InnoDB AUTO_INCREMENT=4033 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.cuotasmeses
DROP TABLE IF EXISTS `cuotasmeses`;
...
-- Volcando estructura para tabla se_sanfra.cuotaspagos
...
) ENGINE=InnoDB AUTO_INCREMENT=35029 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.cuotastipo
DROP TABLE IF EXISTS `cuotastipo`;
...
-- Volcando estructura para tabla se_sanfra.cuotastipopago
DROP TABLE IF EXISTS `cuotastipopago`;
...
-- Volcando estructura para tabla se_sanfra.curplan
...
-- Volcando estructura para tabla se_sanfra.cursos
...
-- Volcando estructura para tabla se_sanfra.datosvarios
...
-- Volcando estructura para tabla se_sanfra.emails
...
-- Volcando estructura para tabla se_sanfra.emails_enviados_morosos
DROP TABLE IF EXISTS `emails_enviados_morosos`;
...
-- Volcando estructura para tabla se_sanfra.enletras
DROP TABLE IF EXISTS `enletras`;
...
-- Volcando estructura para tabla se_sanfra.ento
DROP TABLE IF EXISTS `ento`;
...
-- Volcando estructura para tabla se_sanfra.estadocivil
...
-- Volcando estructura para tabla se_sanfra.evaluac
DROP TABLE IF EXISTS `evaluac`;
...
-- Volcando estructura para tabla se_sanfra.familias
...
CREATE TABLE IF NOT EXISTS `familias` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1615 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.fechascalendario
DROP TABLE IF EXISTS `fechascalendario`;
...
-- Volcando estructura para tabla se_sanfra.horarios
...
-- Volcando estructura para tabla se_sanfra.horarios26
DROP TABLE IF EXISTS `horarios26`;
...
-- Volcando estructura para tabla se_sanfra.horariosespeciales
DROP TABLE IF EXISTS `horariosespeciales`;
...
-- Volcando estructura para tabla se_sanfra.ief
DROP TABLE IF EXISTS `ief`;
...
-- Volcando estructura para tabla se_sanfra.inasdocentes
DROP TABLE IF EXISTS `inasdocentes`;
...
) ENGINE=InnoDB AUTO_INCREMENT=1981 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.inasistencias
...
-- Volcando estructura para tabla se_sanfra.inasistencias_valores
DROP TABLE IF EXISTS `inasistencias_valores`;
...
-- Volcando estructura para tabla se_sanfra.indicadores
...
-- Volcando estructura para tabla se_sanfra.infoxobse
DROP TABLE IF EXISTS `infoxobse`;
...
-- Volcando estructura para tabla se_sanfra.legajos
...
CREATE TABLE IF NOT EXISTS `legajos` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `dni` (`dni`)
) ENGINE=InnoDB AUTO_INCREMENT=3413 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.librodetemas
DROP TABLE IF EXISTS `librodetemas`;
...
-- Volcando estructura para tabla se_sanfra.licencias
...
-- Volcando estructura para tabla se_sanfra.log
...
-- Volcando estructura para tabla se_sanfra.materias
...
-- Volcando estructura para tabla se_sanfra.matplan
DROP TABLE IF EXISTS `matplan`;
...
-- Volcando estructura para tabla se_sanfra.matricula
...
) ENGINE=InnoDB AUTO_INCREMENT=9594 DEFAULT CHARSET=utf8;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.mesasexamen
...
-- Volcando estructura para tabla se_sanfra.miembrosmesaexamen
DROP TABLE IF EXISTS `miembrosmesaexamen`;
...
-- Volcando estructura para tabla se_sanfra.morososavisos
DROP TABLE IF EXISTS `morososavisos`;
CREATE TABLE IF NOT EXISTS `morososavisos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fecha` date NOT NULL,
  `emailDestino` varchar(50) COLLATE utf8_spanish_ci NOT NULL DEFAULT '',
...
-- Volcando estructura para tabla se_sanfra.niveles
...
-- Volcando estructura para tabla se_sanfra.nombresmaterias
DROP TABLE IF EXISTS `nombresmaterias`;
...
-- Volcando estructura para tabla se_sanfra.notasexamen
DROP TABLE IF EXISTS `notasexamen`;
...
-- Volcando estructura para tabla se_sanfra.notasief
DROP TABLE IF EXISTS `notasief`;
...
-- Volcando estructura para tabla se_sanfra.notaspermitidas
DROP TABLE IF EXISTS `notaspermitidas`;
...
-- Volcando estructura para tabla se_sanfra.permisosusuarios
...
-- Volcando estructura para tabla se_sanfra.planes
...
-- Volcando estructura para tabla se_sanfra.planillasdescargacuotas
DROP TABLE IF EXISTS `planillasdescargacuotas`;
...
) ENGINE=InnoDB AUTO_INCREMENT=976 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.plapro
DROP TABLE IF EXISTS `plapro`;
...
-- Volcando estructura para tabla se_sanfra.ppc
...
-- Volcando estructura para tabla se_sanfra.ppi
...
-- Volcando estructura para tabla se_sanfra.profesores
...
-- Volcando estructura para tabla se_sanfra.profesortipo
...
-- Volcando estructura para tabla se_sanfra.proveedores
...
-- Volcando estructura para tabla se_sanfra.reinco2025
DROP TABLE IF EXISTS `reinco2025`;
...
-- Volcando estructura para tabla se_sanfra.reinco2025_tipo
DROP TABLE IF EXISTS `reinco2025_tipo`;
...
-- Volcando estructura para tabla se_sanfra.reincorporaciones
DROP TABLE IF EXISTS `reincorporaciones`;
...
-- Volcando estructura para tabla se_sanfra.reloj
...
-- Volcando estructura para tabla se_sanfra.rendicionesroela
DROP TABLE IF EXISTS `rendicionesroela`;
...
) ENGINE=InnoDB AUTO_INCREMENT=36034 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.repopp
DROP TABLE IF EXISTS `repopp`;
...
-- Volcando estructura para tabla se_sanfra.sanciones
...
-- Volcando estructura para tabla se_sanfra.sanciontipo
DROP TABLE IF EXISTS `sanciontipo`;
...
-- Volcando estructura para tabla se_sanfra.sexos
...
-- Volcando estructura para tabla se_sanfra.situacionrevista
...
-- Volcando estructura para tabla se_sanfra.solibecahist
DROP TABLE IF EXISTS `solibecahist`;
CREATE TABLE IF NOT EXISTS `solibecahist` (
  ...
  `nro` int(10) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=660 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.temasrecup
DROP TABLE IF EXISTS `temasrecup`;
...
-- Volcando estructura para tabla se_sanfra.terlec
DROP TABLE IF EXISTS `terlec`;
...
-- Volcando estructura para tabla se_sanfra.tipoclase
DROP TABLE IF EXISTS `tipoclase`;
CREATE TABLE IF NOT EXISTS `tipoclase` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tipoClase` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla se_sanfra.tipoinadoc
DROP TABLE IF EXISTS `tipoinadoc`;
...
-- Volcando estructura para tabla se_sanfra.tipomovimiento
...
-- Volcando estructura para tabla se_sanfra.turnos
...
-- Volcando estructura para tabla se_sanfra.turnosexamen
...
-- Volcando estructura para tabla se_sanfra.ud_tipodoc
DROP TABLE IF EXISTS `ud_tipodoc`;
...
-- Volcando estructura para tabla se_sanfra.upload_doc
DROP TABLE IF EXISTS `upload_doc`;
...
-- Volcando estructura para tabla se_sanfra.usermenu
...
-- Volcando estructura para tabla se_sanfra.vacia
...
-- Volcando estructura para tabla se_sanfra.variosalumnos
DROP TABLE IF EXISTS `variosalumnos`;
